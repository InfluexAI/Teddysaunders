    ...
    <section className="wk-sec wk-sec--dark" id="wk-investors">
      ...
      <div className="wk-inner">
        <div className="wk-head wk-reveal">
          <p className="wk-eyebrow"><span className="wk-slash">/</span> For Investors</p>
          <h2 className="wk-head__title wk-textured">Back original<br />projects and IP</h2>
          <div className="wk-body">
            <p>Personally invest in high impact original visions. Unique stories and platforms designed to transform, touch and uplift humanity.</p>
          </div>
        </div>
