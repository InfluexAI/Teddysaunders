  ...
  return (
    <section className="wk2-hero">
      <div className="wk2-hero__bg" ref={bgRef} aria-hidden="true">
        <video src="assets/work-hero.mp4" autoPlay loop muted playsInline preload="auto"></video>
      </div>
      ...
      <div className="wk2-hero__inner">
        ...
        <p className="wk2-proofhead">Results proven by ruthless detail and one-of-a-kind genius.</p>
        ...
        {WK2_TABS.map((t, i) => (
          <button className={"wk-tab" + (i === current ? " is-current" : "")} key={t.to} onClick={() => onJump && onJump(t.to)}>
            ...
            <span className="wk-tab__arrow" aria-hidden="true">
              <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.7"><path d="M12 5v14M6 13l6 6 6-6" /></svg>
            </span>
          </button>
        ))}
      </div>
